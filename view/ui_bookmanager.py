...
class Ui_BookManager(object):
    def setupUi(self, BookManager):
        ...
        BookManager.resize(1067, 515)
        self.table_books = QtWidgets.QTableWidget(BookManager)
        self.table_books.setGeometry(QtCore.QRect(210, 20, 841, 441))
        self.table_books.setObjectName("table_books")
        self.table_books.setColumnCount(0)
        self.table_books.setRowCount(0)
        self.layoutWidget = QtWidgets.QWidget(BookManager)
        self.layoutWidget.setGeometry(QtCore.QRect(650, 470, 395, 30))
        ...
        self.layoutWidget1 = QtWidgets.QWidget(BookManager)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 20, 171, 151))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.layoutWidget1)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.txt_book_id = QtWidgets.QLineEdit(self.layoutWidget1)
        self.txt_book_id.setText("")
        self.txt_book_id.setObjectName("txt_book_id")
        self.verticalLayout.addWidget(self.txt_book_id)
        self.txt_title = QtWidgets.QLineEdit(self.layoutWidget1)
        ...
        self.txt_genre = QtWidgets.QLineEdit(self.layoutWidget1)
        self.txt_genre.setText("")
        self.txt_genre.setObjectName("txt_genre")
        self.verticalLayout.addWidget(self.txt_genre)
        self.cmb_status = QtWidgets.QComboBox(self.layoutWidget1)
    ...
    def retranslateUi(self, BookManager):
        ...
        self.txt_book_id.setPlaceholderText(_translate("BookManager", "ID del libro"))
        self.txt_title.setPlaceholderText(_translate("BookManager", "Título"))
        self.txt_author.setPlaceholderText(_translate("BookManager", "Autor"))
        self.txt_genre.setPlaceholderText(_translate("BookManager", "Género"))
